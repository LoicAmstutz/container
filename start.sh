...
echo "\n für Mongo-Datenbank"
docker run --name mongodb -p 27017:27017 -d -e MONGO_INITDB_ROOT_USERNAME=admin -e MONGO_INITDB_ROOT_PASSWORD=Welcome$21 --net mongo-network mongo

echo "\n für UI von Mongo-Datenbank"
